...
public class FlowableFragment extends Fragment {
    ...
    private FlowableViewModel pageViewModel;
    private FragmentFlowableBinding binding;

    public static FlowableFragment newInstance(int index) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pageViewModel = new ViewModelProvider(this).get(FlowableViewModel.class);
        int index = 1;
